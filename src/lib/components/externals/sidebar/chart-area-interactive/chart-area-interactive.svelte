<script lang="ts">
	import * as Chart from '$lib/components/internals/chart/index.js';
	import * as Card from '$lib/components/internals/card/index.js';
	import * as Select from '$lib/components/internals/select/index.js';
	import * as ToggleGroup from '$lib/components/internals/toggle-group/index.js';
